...
class Curp
{
    ...
    public function __construct($nombres, $apellido_paterno, $apellido_materno,
        $fecha_nacimiento, $genero, $entidad_nacimiento)
    {
        ...
        $this->entidad_nacimiento = trim($entidad_nacimiento);
        ...
        $entidad_nacimiento)
    {
        ...
        */
         ...
         */
        if ( ! array_key_exists(strval($entidad_nacimiento), $this->entidades))
        {
            return '';
        }
         ...
         */
        $curp = $curp . $this->entidades[strval($entidad_nacimiento)]['abrev'];
